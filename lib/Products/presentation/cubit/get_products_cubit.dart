...
class GetProductsCubit extends Cubit<GetProductsState> {
  ...
  Future<void> getProducts() async {
    ...
    try {
      Either<Failure,ProductsDataEntity> response = await getProductsUsecse.call(NoParmas());
      emit(response.fold((l) => GetProductsErrorState(error:_mapFailureToMsg(l) ), (r) => GetProducstLoadedState(productsDataEntity: r)));
    } catch (error) {
